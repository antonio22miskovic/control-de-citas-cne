...
{{--                             <label for="email" class="col-md-3 col-form-label text-md-right">{{ __('Usuario') }}</label> --}}
                            ...
                            <div class="col-md-12">
                                <input id="email" type="email" class="form-control form-control-lg @error('email') is-invalid @enderror" name="email" placeholder="Ingrese su email" value="{{ old('email') }}" required autocomplete="email" autofocus>
